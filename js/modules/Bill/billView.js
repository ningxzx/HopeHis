...
define(['txt!../Common/sidebar.html',
    ...
    function (sidebarTemp,retailPricingView,afterPayView,chargeView,refundView,dispenseView,searchChargeView,searchCreditView,searchRefundView,searchSettleView,settleView,retailDrugRecordView,jquery,Handlebars,backbone){
        var sidebarData={
            ...
            submenus: [
                { spanClass: "am-icon-list-ol", submenu: "收费", sublink: "#bill/charge", parents: "", subid: "bill_charge"},
                { spanClass: "am-icon-money", submenu: "退费", sublink: "#bill/refund", parents: "", subid: "bill_refund"},
                { spanClass: "am-icon-file-archive-o", submenu: "收费记录", sublink: "#bill/searchCharge", parents: "", subid: "bill_searchCharge"},
                { spanClass: "am-icon-file-archive-o", submenu: "退费记录", sublink: "#bill/searchRefund", parents: "", subid: "bill_searchRefund"},
                ...
                { spanClass: "am-icon-file-o", submenu: "对账", sublink: "#bill/settle", parents: "", subid: "bill_settle"},
                { spanClass: "am-icon-copy", submenu: "对账纪录", sublink: "#bill/searchSettle", parents: "", subid: "bill_searchSettle"},
