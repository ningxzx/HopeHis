define(["backbone",'../../Setting/myFeedback/myFeedbackModel'], function (Backbone, myFeedbackModel) {
    var myFeedbackCollection = Backbone.Collection.extend({
        model: myFeedbackModel,
