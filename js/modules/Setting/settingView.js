...
define(['txt!../Common/sidebar.html',
    ...
    function (sidebarTemp, myClinicView,functionSettingView, changePersonalView, userMangeView, dicTableMaintainView, recipeMaintainView, menuSetView, checkSetView, recipeFeeSetView, typiclCaseView, adviceSetView, departMangeView, registerFeeSetView, accountReferView, sysDataBackupView, SetwindowView, myFeedbackView, jquery, Handlebars, backbone) {
        var sidebarData = {
            ...
            submenus: [
                {spanClass: "am-icon-home", submenu: "我的诊所", sublink: "#setting/myClinic", subid: "setting_myClinic", parents: ""},
                {spanClass: "am-icon-twitter", submenu: "功能设置", sublink: "#setting/functionSetting", subid: "setting_functionSetting", parents: ""},
                {spanClass: "am-icon-github-alt", submenu: "修改个人信息", sublink: "#setting/changePersonal", subid: "setting_changePersonal", parents: ""},
                {spanClass: "am-icon-bank", submenu: "科室管理", sublink: "#setting/departMange", subid: "setting_departMange", parents: ""},
                {spanClass: "am-icon-android", submenu: "用户管理", sublink: "#setting/userMange", subid: "setting_userMange", parents: ""},
                { spanClass: "am-icon-ils", submenu: "角色权限设置", sublink: "#setting/menuSet", subid: "setting_menuSet", parents: ""},
                {spanClass: "am-icon-cny", submenu: "挂号费用设置", sublink: "#setting/registerFeeSet", subid: "setting_registerFeeSet", parents: ""},
                {spanClass: "am-icon-building", submenu: "诊疗模板设置", sublink: "#setting/recipeMaintain", subid: "setting_recipeMaintain", parents: ""},
                {spanClass: "am-icon-stethoscope", submenu: "检查项目设置", sublink: "#setting/checkSet", subid: "setting_checkSet", parents: ""},
                //{spanClass: "am-icon-apple", submenu: "处方费用设置", sublink: "#setting/recipeFeeSet", subid: "setting_recipeFeeSet",parents: ""},
                {spanClass: "am-icon-book", submenu: "字典表维护", sublink: "#setting/dicTableMaintain", subid: "setting_dicTableMaintain", parents: ""},
