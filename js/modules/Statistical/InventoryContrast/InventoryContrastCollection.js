define(["backbone",'../../Statistical/InventoryContrast/InventoryContrastModel'], function (Backbone, InventoryContrastModel) {
    var InventoryContrastCollection = Backbone.Collection.extend({
        model: InventoryContrastModel,
    ...
    return InventoryContrastCollection;
});
