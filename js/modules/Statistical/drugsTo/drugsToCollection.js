define(["backbone",'../../Statistical/drugsTo/drugsToModel'], function (Backbone, drugsToModel) {
    var drugsToCollection = Backbone.Collection.extend({
        model: drugsToModel,
