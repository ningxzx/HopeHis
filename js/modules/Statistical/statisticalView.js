    ...
    function (sidebarTemp,outpatientChargesView,drugSalesView,clinicFinancialView,inspectionItemView,typicalDiseaseView,yearReportView,drugPurchaseView,purchaseReturnView,outpatientServiceView,workloadStatisticsView,InventoryContrastView,drugsToView,prescriptionStatisticsView,departmentView,jquery,Handlebars,backbone){
        var sidebarData={
            ...
            submenus: [
                ...
                { spanClass: "am-icon-info", submenu: "诊所财务统计", sublink: "#statistical/clinicFinancial",subid:"statistical_clinicFinancial",parents: ""},
                ...
                { spanClass: "am-icon-info", submenu: "处方统计", sublink: "#statistical/prescriptionStatistics", subid:"statistical_prescriptionStatistics",parents: ""},
                { spanClass: "am-icon-info", submenu: "年/月报表统计", sublink: "#statistical/yearReport", subid:"statistical_yearReport",parents: ""},
                { spanClass: "am-icon-info", submenu: "药品采购统计", sublink: "#statistical/drugPurchase", subid:"statistical_drugPurchase",parents: ""},
                ...
                { spanClass: "am-icon-info", submenu: "药品去向统计", sublink: "#statistical/drugsTo", subid:"statistical_drugsTo",parents: ""},
                { spanClass: "am-icon-info", submenu: "科室统计", sublink: "#statistical/department", subid:"statistical_department",parents: ""},
            ]
        };
        var subviews={
